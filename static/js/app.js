    ...
    initLocalization() {
        this.translations = {
            'en': {
                ...
                'modality_filter_help': 'Filter by modality, e.g. MR, CT. Synonyms like DR/DX/CR are matched automatically.',
            ...
            'zh': {
                ...
                'modality_filter_help': '按模态过滤，如 MR, CT。DR/DX/CR 等同义词会自动匹配。',
